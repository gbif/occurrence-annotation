...
public class RuleController implements Controller<Rule> {
  ...
  public List<Rule> list(
    ...
    // Debug logging
    System.out.println("DEBUG: basisOfRecord parameter = '" + basisOfRecord + "'");
    System.out.println("DEBUG: basisOfRecord is null? " + (basisOfRecord == null));
    System.out.println("DEBUG: basisOfRecord is empty? " + (basisOfRecord != null && basisOfRecord.isEmpty()));
