...
public class StatsController {
  ...
  @Parameter(name = "limit", description = "Maximum number of creators to return (default: 10)")
  ...
  @Parameter(name = "limit", description = "Maximum number of projects to return (default: 10)")
