...
VALUES (1, 'Test Project', 'Test project for integration tests', ARRAY['test-user', 'user-alpha', 'user-beta', 'user-gamma', 'user-delta'], NOW(), 'test-user');
...
VALUES (1, 1, 'Test Ruleset', 'Test ruleset for integration tests', ARRAY['test-user', 'user-alpha', 'user-beta', 'user-gamma', 'user-delta'], NOW(), 'test-user');
