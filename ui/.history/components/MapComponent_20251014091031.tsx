    ...
    >
      ...
      >
        ...
        {!isZooming && gbifTiles.map((tile) => {
          ...
          console.log('🎨 RENDERING GBIF TILE:', {
            tileCoords: `${tile.x},${tile.y},${tile.z}`,
            anchor: [nwLat, nwLng],
            displaySize,
            url: tile.url
          });
              ...
              <div style={{ pointerEvents: 'none' }}>
                <img
                  ...
                  style={{
                    ...
                    opacity: 0.7,
                    border: '2px solid red', // Debug border to see tile boundaries
                  }}
                  onLoad={(e) => {
                    console.log('✅ GBIF TILE LOADED:', tile.url);
                  }}
                  onError={(e) => {
                    console.error('❌ GBIF TILE FAILED:', tile.url);
