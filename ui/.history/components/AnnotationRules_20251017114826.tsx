          ...
          return (
            <Card key={rule.id} className="p-3">
              <div className="flex gap-2">
                {/* Left column: Mini map and basic info */}
                <div className="flex-shrink-0 w-52">
                  ...
                  {/* Annotation badge and level */}
                  <div className="space-y-1.5">
                    <div className="flex gap-1.5 items-center">
                      <Badge className={getAnnotationColor(rule.annotation)} variant="outline" size="sm">
                        {rule.annotation}
                      </Badge>
                    ...
                    <div className="text-sm space-y-1">
                      <div>
                        ...
                        <div className="text-gray-900 font-mono text-xs">{rule.id}</div>
                      </div>
                      <div>
                        <div className="text-xs text-gray-400">Taxon Key</div>
                        <div className="text-gray-900 font-mono text-xs">{rule.taxonKey}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 min-w-0 pl-1">
                  <div className="flex justify-between items-start gap-3">
                    <div className="space-y-2">
                      {/* Scientific name - prominently displayed */}
                      {rule.scientificName && (
                        <div>
                          <div className="text-xs text-gray-400 mb-1">Scientific Name</div>
                          <div className="text-base font-medium italic text-gray-900">{rule.scientificName}</div>
                        </div>
                      )}
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm max-w-sm">
                        <div>
                          ...
                          <div className="text-gray-900">{rule.createdBy}</div>
                        </div>
                        <div>
