  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* TEST POLYGON: Fixed geographic coordinates that should move with map */}
        <Overlay anchor={[40.7589, -73.9851]} offset={[0, 0]}>
          <div style={{ pointerEvents: 'none' }}>
            <svg width="200" height="200" style={{ overflow: 'visible' }}>
              ...
              />
              <text x="10" y="20" fill="#ff0000" fontSize="12" fontWeight="bold">
                TEST POLYGON
              </text>
              <text x="10" y="35" fill="#ff0000" fontSize="10">
                Fixed at NYC coordinates
              </text>
              <text x="10" y="50" fill="#ff0000" fontSize="10">
                Should move with map
              </text>
            </svg>
          </div>
        </Overlay>
