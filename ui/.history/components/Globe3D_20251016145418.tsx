...
export function Globe3D({ 
  ...
  useEffect(() => {
    ...
    sphereGradient.addColorStop(0.4, '#f0f9ff');
    sphereGradient.addColorStop(1, '#e2e8f0');
    ...
    // Draw graticule (grid lines) - more prominent for 3D effect
    const graticule = geoGraticule()
      .step([15, 15]); // 15-degree intervals for cleaner look
    ...
    // Add prominent meridians and parallels for 3D depth
    const prominentGraticule = geoGraticule()
      .step([30, 30]); // 30-degree intervals for major lines
    
    ctx.beginPath();
    path(prominentGraticule());
    ...
    // Add highlight effect for 3D appearance - simulates light reflection
    ...
    // Add subtle rim lighting on the edge
