  ...
  useEffect(() => {
    ...
    const drawWorldMap = () => {
      ...
      const worldToCanvas = (lat: number, lng: number) => {
        // World coordinates: lat (-90 to 90), lng (-180 to 180)
      ...
      const continents = [
        // North America
        { coords: [[70, -140], [50, -60], [20, -80], [25, -120], [60, -160]] },
        // South America  
        { coords: [[10, -80], [5, -35], [-30, -40], [-55, -70], [-20, -85]] },
        // Europe
        { coords: [[70, -10], [60, 40], [40, 30], [50, 0]] },
        // Africa
        { coords: [[35, 0], [35, 50], [-35, 40], [-35, 10], [15, 0]] },
        // Asia
        { coords: [[70, 40], [70, 180], [10, 140], [20, 60]] },
        // Australia
