...
export function MapComponent({
  ...
  }, [editingPolygonId, onUpdatePolygon, savedPolygons]); // Include all dependencies
          ...
          return (
            <Overlay key={`overlay-${polygonData.id}`} anchor={[anchorLat, anchorLng]} offset={[0, 0]}>
              <div 
                ...
                onMouseDown={(e) => {
                  // Don't start polygon drag if we're in editing mode or clicking on a vertex
