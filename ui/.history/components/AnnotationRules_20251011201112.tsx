        ...
        const rulesWithCoords = uniqueRules.map(rule => {
          ...
          if (multiPolygon && multiPolygon.length > 0) {
            console.log('DEBUG: Annotation Rule Coordinates', {
              ...
              firstPolygonFirstCoord: multiPolygon[0] && multiPolygon[0][0] ? multiPolygon[0][0][0] : null,
              coordCount: multiPolygon[0] ? multiPolygon[0][0]?.length : 0,
              sampleCoords: multiPolygon[0] && multiPolygon[0][0] ? multiPolygon[0][0].slice(0, 3) : []
            });
          }
