...
export function MiniMapPreview({
  ...
  function getPolygonCentroid(ring: [number, number][]): [number, number] | null {
    ...
    // Calculate centroid in lat/lng space first
      ...
      >
        ...
        {isInverted ? (
          ...
          (() => {
            ...
            // Build one combined path with world boundary and all polygons as holes
          ...
          polygonCoordinates.map((ring, index) => {
            ...
            if (shouldRenderAsDot) {
              ...
              const projectedCentroid = projection([centroid[1], centroid[0]]); // [lng, lat] for projection
