...
export function GlobeView({ multiPolygon, annotation, onClick }: GlobeViewProps) {
  ...
  return (
    <div 
      className={`w-[100px] h-[100px] border border-gray-200 rounded bg-gray-50 overflow-hidden flex items-center justify-center ${onClick ? 'cursor-pointer hover:bg-gray-100 transition-colors' : ''}`}
      onClick={onClick}
    >
      <ComposableMap
