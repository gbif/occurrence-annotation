...
export function MapComponent({
  ...
  return (
    <div 
      ...
      onMouseDown={() => {
        // Start map interaction - freeze current map state for stable polygon rendering
        if (!isMapInteracting) {
          setIsMapInteracting(true);
          setFrozenMapState({ center, zoom });
          console.log('🗺️ Map interaction started - freezing polygon coordinates');
        }
      }}
      onMouseLeave={() => {
