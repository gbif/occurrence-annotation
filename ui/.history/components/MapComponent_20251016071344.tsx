          ...
          <>
            ...
            {savedPolygons.length > 0 && !editingPolygonId && (
              <>
                ...
                <div className="px-2 py-1 text-xs text-gray-600 font-medium">Edit Polygons:</div>
            ...
            {editingPolygonId && (
              <>
                <div className="w-full h-px bg-gray-200 my-1" />
                <div className="px-2 py-1 text-xs text-gray-600 font-medium">Editing Tools:</div>
                <Button 
