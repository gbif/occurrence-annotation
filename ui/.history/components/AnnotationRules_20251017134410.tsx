          ...
          return (
            <Card key={rule.id} className="p-4">
              <div className="space-y-4">
                ...
                {/* Rule information below the map */}
                <div className="space-y-3">
                  {/* Scientific name - prominently displayed */}
                  {rule.scientificName && (
                    <div className="text-center">
                      <div className="text-sm text-gray-400 mb-1">Scientific Name</div>
                      <div className="text-xl font-medium italic text-gray-900">{rule.scientificName}</div>
                    </div>
                  )}
                  
                  {/* Grid of information - using 2 columns on larger screens, single column on smaller */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="text-xs text-gray-400 mb-0.5">Rule ID</div>
                      <div className="text-gray-900 font-mono text-xs break-all">{rule.id}</div>
                    </div>
                    <div>
