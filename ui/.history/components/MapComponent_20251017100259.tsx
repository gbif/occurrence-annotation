...
export function MapComponent({
  ...
  const handleMapClick = ({ latLng }: { latLng: [number, number] }) => {
    ...
    console.log('🗺️ MapComponent: handleMapClick called with:', { lat, lng, isInvestigateMode, dialogOpen: isInvestigateDialogOpen, isDragging });
    
    // Don't trigger investigation if this was a drag event
    if (isDragging) {
      console.log('🗺️ MapComponent: Ignoring click - was a drag event');
      return;
    }
