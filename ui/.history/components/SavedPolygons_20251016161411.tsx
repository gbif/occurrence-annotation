...
function shouldUseGlobeView(coordinates: [number, number][] | [number, number][][], isMultiPolygon = false): boolean {
  ...
  // Use globe view for polygons up to about 30 degrees in any dimension
  // This covers small to medium-sized regions like states, provinces, or small countries
  return latRange < 30 || lngRange < 30;
}
