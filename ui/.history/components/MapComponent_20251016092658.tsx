      ...
      >
        ...
        {!isDrawing ? (
          <>
            ...
            {currentPolygon && (
              <>
                {/* Latitude Band Controls - simple +/- when band is active */}
                {showLatBandControls && (
                  <div className="flex items-center gap-1 bg-blue-50 border border-blue-200 rounded px-2 py-1">
                    <span className="text-xs font-medium text-blue-700">Band:</span>
                    <Button
                      size="icon"
                      variant="ghost"
