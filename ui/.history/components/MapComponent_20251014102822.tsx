...
export function MapComponent({
  ...
  return (
    <div 
      ...
      onMouseDown={() => {
        // Start map interaction - prevent stable ref updates during drag
        isMapDragging.current = true;
        console.log('🗺️ Map drag started - polygon coordinates frozen');
      }}
      onMouseLeave={() => {
        setMousePosition(null);
        handleMouseUp();
        // End map interaction when mouse leaves
        isMapDragging.current = false;
        stableMapRef.current = { center, zoom };
        console.log('🗺️ Map interaction ended - stable ref updated');
      }}
      onClick={(e) => {
