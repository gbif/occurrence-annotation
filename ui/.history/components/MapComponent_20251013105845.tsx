...
// Note: pigeon-maps expects Web Mercator tiles, but GBIF provides EPSG:4326 tiles
// This may cause slight coordinate misalignment at higher zoom levels
const gbifTileProvider = (x: number, y: number, z: number) => {
  const url = `https://tile.gbif.org/4326/omt/${z}/${x}/${y}@1x.png?style=gbif-geyser-en&srs=EPSG%3A4326`;
  console.log(`🗺️ Loading EPSG:4326 tile: z=${z}, x=${x}, y=${y}`);
  return url;
};
