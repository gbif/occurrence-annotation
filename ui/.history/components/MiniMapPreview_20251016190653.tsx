  ...
  return (
    <div className={`border border-gray-200 rounded overflow-hidden ${className}`}
      ...
      >
        ...
        {/* Render the polygon(s) using projected coordinates */}
        {polygonCoordinates.map((ring, index) => {
          if (ring.length === 0) return null;
          
          // Create a GeoJSON-like polygon for proper projection
          const polygonGeoJSON = {
            type: "Feature" as const,
            geometry: {
              type: "Polygon" as const,
              coordinates: [ring] // Wrap in array since Polygon expects array of rings
            }
          };
