...
// Debug function to analyze coordinate transformations
const debugCoordinateTransform = (wkt: string) => {
  console.log('🔍 DEBUGGING WKT COORDINATES:');
  console.log('Original WKT:', wkt.substring(0, 200) + '...');
