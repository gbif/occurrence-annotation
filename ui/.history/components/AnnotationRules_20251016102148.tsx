  ...
  const renderPolygonPreview = (multiPolygon: MultiPolygon | undefined, annotation: string, onClick?: () => void) => {
    ...
    return (
      ...
      >
        ...
        <defs>
          <pattern id="worldMap" patternUnits="userSpaceOnUse" width={svgSize} height={svgSize}>
            {/* Simplified world map - continents as basic shapes */}
            <g opacity="0.15" fill="#6b7280">
              {/* North America - simplified */}
              <path d="M8 12 L18 10 L22 15 L20 20 L15 22 L8 20 Z"/>
              {/* South America - simplified */}
              <path d="M16 25 L20 22 L22 30 L20 40 L16 42 L14 35 Z"/>
              {/* Europe - simplified */}
              <path d="M26 8 L32 10 L30 15 L26 12 Z"/>
              {/* Africa - simplified */}
              <path d="M26 15 L30 15 L32 25 L30 35 L26 38 L24 25 Z"/>
              {/* Asia - simplified */}
              <path d="M32 8 L50 10 L52 20 L48 25 L32 20 Z"/>
              {/* Australia - simplified */}
              <path d="M42 35 L48 34 L50 38 L46 40 L42 38 Z"/>
            </g>
          </pattern>
        </defs>
        
        {/* Background with world map */}
        <rect width={svgSize} height={svgSize} fill="url(#worldMap)"/>
