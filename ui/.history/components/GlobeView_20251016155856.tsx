...
export function GlobeView({ multiPolygon, annotation, onClick }: GlobeViewProps) {
  ...
  return (
    <div 
      className={`w-[100px] h-[100px] border border-gray-200 rounded bg-gray-200 overflow-hidden flex items-center justify-center ${onClick ? 'cursor-pointer hover:bg-gray-300 transition-colors' : ''}`}
      onClick={onClick}
    >
      <ComposableMap
      ...
      >
        <Graticule stroke="#d1d5db" strokeWidth={0.2} />
