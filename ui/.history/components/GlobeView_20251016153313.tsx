...
export function GlobeView({ multiPolygon, annotation, onClick }: GlobeViewProps) {
  ...
  if (allCoords.length === 0) {
    return (
      <div className="w-[60px] h-[60px] border border-gray-200 rounded bg-gray-100 flex items-center justify-center">
  ...
  return (
    <div 
      className={`w-[60px] h-[60px] border border-gray-200 rounded bg-gray-50 overflow-hidden ${onClick ? 'cursor-pointer hover:bg-gray-100 transition-colors' : ''}`}
      onClick={onClick}
    >
      <ComposableMap
