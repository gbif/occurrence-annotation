  ...
  const renderPolygonPreview = (multiPolygon: MultiPolygon | undefined, annotation: string, onClick?: () => void) => {
    ...
    if (multiPolygon.polygons.length === 1) {
      ...
      if (isOriginallyInverted && polygon.holes && polygon.holes.length > 0) {
        // For inverted polygons, show the holes as normal polygons (the areas to highlight)
        // The MiniMapPreview will NOT invert these since they represent the actual target areas
        ...
        // Don't set isInverted=true because we want to show the holes as highlighted areas
        isInverted = false;
      } else {
