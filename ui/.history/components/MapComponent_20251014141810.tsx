...
export function MapComponent({
  ...
  return (
    ...
    >
      ...
      {isZooming && (
        <div className="absolute top-4 right-4 bg-orange-600 text-white rounded-lg shadow-lg p-2 z-30">
          <div className="flex items-center gap-2">
            <div className="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent"></div>
            <span className="text-sm font-medium">Zooming...</span>
          </div>
          <p className="text-xs mt-1 opacity-90">Polygons frozen until zoom completes</p>
        </div>
      )}
