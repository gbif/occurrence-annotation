...
const countries = feature(worldData as any, worldData.objects.countries as any);
...
export function MiniMapPreview({
  ...
  return (
    <div className={`border border-gray-200 rounded overflow-hidden ${className}`}
         style={{ backgroundColor: '#222' }}> {/* Darker for water */}
      <ComposableMap
        ...
        style={{
          width: '100%',
          height: '100%',
          backgroundColor: '#222', // Darker for water
        }}
      >
        <ZoomableGroup>
