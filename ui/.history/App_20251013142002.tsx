...
export default function App() {
  ...
  return (
    <div className="h-screen flex flex-col">
      <Toaster />
      <header className="bg-white border-b px-6 py-4" style={{ contain: 'layout' }}>
        ...
        <p className="text-gray-600 text-sm mb-3">Create rule-based annotations for species occurrence data</p>
