    ...
    try {
      ...
      if (multiPolygon.polygons.length === 1) {
        ...
        if (hasInvertedPolygon) {
          ...
          isMultiPolygon = true;
          isInverted = false; // Since we extracted the holes, treat as normal polygons for display
          
          console.log('🔄 Processed inverted multipolygon - extracted holes as normal polygons:', {
            originalPolygonCount: multiPolygon.polygons.length,
            resultingPolygonCount: allPolygons.length,
            isInverted: false,
            note: 'Holes extracted and converted to normal polygons for proper display'
          });
        } else {
