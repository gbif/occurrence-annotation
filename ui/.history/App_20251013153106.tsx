...
export default function App() {
  ...
  const handleAreaInvestigate = useCallback((lat: number, lng: number, radius: number) => {
    // This will be passed to the InvestigateArea component to handle map clicks
    console.log('Area investigate:', { lat, lng, radius });
  }, []);
      ...
      <header className="bg-white border-b px-6 py-4">
        ...
        <div className="flex items-center gap-4 min-h-[40px] max-h-[60px]" style={{ overflow: 'visible' }}>
          ...
          <InvestigateArea
            ...
            onToggleInvestigateMode={setIsInvestigateMode}
            onAreaInvestigate={handleAreaInvestigate}
          />
        </div>
      </header>
