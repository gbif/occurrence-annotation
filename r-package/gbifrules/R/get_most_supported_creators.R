...
#'
#' Returns top rule creators ordered by total support count (sum of supports across all their rules).
#'
...
#' }
get_most_supported_creators <- function(limit = 10) {
  
  url <- paste0(gbifrules_url("stats"), "/most-supported-creators")
