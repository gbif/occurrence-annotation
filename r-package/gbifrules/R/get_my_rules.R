...
#'
#' @return A `tibble` of rules created by the authenticated user.
#' @export
#'
#' @examples
#' \dontrun{
...
#' }
get_my_rules <- function(limit = NULL, offset = NULL, user = NULL, pwd = NULL, ...) {
  
  url <- paste0(gbifrules_url("rule"), "/my")
