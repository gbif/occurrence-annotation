...
#'
#' Returns all non-deleted rules that the currently authenticated user has supported.
#'
...
#'
#' @return A `tibble` of rules supported by the authenticated user.
#' @export
#'
#' @examples
#' \dontrun{
...
#' }
get_supported_rules <- function(limit = NULL, offset = NULL, user = NULL, pwd = NULL, ...) {
  
  url <- paste0(gbifrules_url("rule"), "/supported")
